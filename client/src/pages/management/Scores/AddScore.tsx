...
import type { SchoolClass, Subject, Student } from '@/types';
...
export default function AddScore() {
    ...
    return (
        <div className="max-w-xl">
            <h1 className="text-2xl font-semibold text-ink2">Add Score</h1>
            <p className="mt-1 text-sm text-muted">Record a student's marks for an exam</p>
